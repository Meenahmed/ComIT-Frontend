...
export class ProductFormComponent implements OnInit {
  ...
  onFileUpload(productdId: any) {
    ...
    this.prodService.uploadImage(productdId, formData).subscribe(
      (res) => {
        console.log(res);
      },
  ...
  downloadProductImage() {
    ...
    this.prodService.downloadImage(this.productId).subscribe(
      (res) => {
        console.log(res);
      },
      (err: HttpErrorResponse) => {
  ...
  save(product: any) {
    if (this.productId) {
      this.prodService.update(product, product.category).subscribe(
        (res) => {
          // console.log(res);
